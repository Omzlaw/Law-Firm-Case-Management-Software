...
{
    public abstract class LFCMSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LFCMSWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LFCMSWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LFCMSDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LFCMSDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LFCMSDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LFCMSDbContext, Task<T>> func)
        {
            T result;
